    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        self.h_rect = rg.Rectangle(rg.Point(center_x + 0.5*width,center_y - 0.5*letter_thickness),rg.Point(center_x - 0.5*width,center_y + 0.5*letter_thickness))
        self.v_rect = rg.Rectangle(rg.Point(center_x - 0.5*letter_thickness,center_y - 0.5*letter_thickness),rg.Point(center_x + 0.5*letter_thickness,center_y + (height - 0.5*letter_thickness)))
